...
class RefractionCubemapTextureBlinnMaterial : public Material {
private:
...
public:
	RefractionCubemapTextureBlinnMaterial(float pReflectionFactor, std::string pTexture, Texture* pSkybox, float pShineness = 20.0f);
	~RefractionCubemapTextureBlinnMaterial() override;
