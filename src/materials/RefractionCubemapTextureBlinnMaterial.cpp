...
void RefractionCubemapTextureBlinnMaterial::_lazyInitializeShader()
{
...
RefractionCubemapTextureBlinnMaterial::RefractionCubemapTextureBlinnMaterial(float pReflectionFactor, std::string pTexture, Texture* pSkybox, float pShineness)
	:	Material("refraCubeTexBlin"),
...
RefractionCubemapTextureBlinnMaterial::~RefractionCubemapTextureBlinnMaterial()
{
...
void RefractionCubemapTextureBlinnMaterial::render(Mesh* pMesh, glm::mat4* pMatrix, glm::mat4* pModel, glm::mat4* pView, glm::mat4* pProjection)
{
	_shader->use();
